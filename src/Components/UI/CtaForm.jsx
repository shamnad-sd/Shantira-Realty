...
const CtaForm = () => {
  ...
  <div className="max-w-7xl mx-auto px-6">
    <div className="bg-[#11363D] rounded-[30px] overflow-hidden flex flex-col lg:flex-row">
      ...
      {/* Right form */}
      <div className="w-full lg:w-[55%] px-8 py-8 lg:py-10 flex items-center">
        <form className="w-full space-y-4">
          {/* Full name + message */}
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
            <div className='space-y-3'>
              <label className="block text-[11px] text-gray-200 mb-1">
                Full Name*
              </label>
              <input
                type="text"
            ...
            <div className='space-y-3'>
              ...
              <button
                type="submit"
                className="w-full h-[44px] rounded-md bg-[#D4A574] text-white text-sm font-medium"
              >
                Send Inquiry
              </button>
            </div>

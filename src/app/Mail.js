    ...
    <tr>
      <td align="center" style="padding: 40px 15px;">
        <table width="600" cellpadding="0" cellspacing="0" border="0" style="background-color: #fff; border-radius: 12px; box-shadow: 0 0 20px rgba(0,0,0,0.05); overflow: hidden;">
          ...
          <!-- Header -->
          <tr>
            <td align="center" style="background-color: #CFA77F; padding: 40px 20px;">
        ...
        <table width="600" cellpadding="0" cellspacing="0" border="0" style="background-color: #fff; border-radius: 12px; box-shadow: 0 0 20px rgba(0,0,0,0.05); overflow: hidden;">
          ...
          <tr>
            <td style="padding: 40px;">
              ...
              <div style="text-align: center; margin-bottom: 30px;">
                <h3 style="font-size: 18px; font-weight: 600; color: #CFA77F; margin: 0 0 15px;">Thanks for contacting us!</h3>
